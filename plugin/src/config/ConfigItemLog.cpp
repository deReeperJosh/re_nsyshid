...
static void enterLogViewer(ConfigItemLog* item)
{
  ...
  while (true)
  {
    ...
    if (redraw)
    {
      ...
      DrawUtils::print(16, 6 + 24, "re_nsyshid - Log viewer");
      DrawUtils::setFontSize(18);
      DrawUtils::print(SCREEN_WIDTH - 16, 8 + 24, getLogStats(item).c_str(), true);
      DrawUtils::drawRectFilled(8, 8 + 24 + 4, SCREEN_WIDTH - 8 * 2, 3, COLOR_BLACK);

      // draw bottom bar
      DrawUtils::drawRectFilled(8, SCREEN_HEIGHT - 24 - 8 - 4, SCREEN_WIDTH - 8 * 2, 3,
                                COLOR_BLACK);
      DrawUtils::setFontSize(18);
...
static void ConfigItemLog_onInput(void* context, WUPSConfigSimplePadData input)
{
...
bool ConfigItemLog_AddToCategory(WUPSConfigCategoryHandle cat, const char* configID,
